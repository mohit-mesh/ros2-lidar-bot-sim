...
#This code is the ownership of Mohit Meshram
############################################################################
import os
...
def generate_launch_description():
    ...
    #however, then you have to create empty world.world
    ...
    #pathWorldFile os.path.join(get package share_directory(namePackage), worldFileRelativePath)
    ...
    #gazeboLaunch-IncludeLaunchDescription(gazebo_rosPackageLaunch, launch_arguments=['gz_args":
    #you are using an empty world model
